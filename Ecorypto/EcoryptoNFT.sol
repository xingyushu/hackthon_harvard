...
import "./SafeMath.sol";
import "./ownable.sol";
import {TRC20Spendable} from "./Ecorypto.sol";
 ...
 */
contract TRC721 is Context, TRC165, ITRC721, Ownable {
    using SafeMath for uint256;
    ...
    TRC20Spendable _mintingCurrency;
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        _mintingCurrency.spend(to, _mintingPrice);
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        _mintingCurrency.spend(from, _mintingPrice);
    ...
    function mintingCurrency() external view returns (TRC20Spendable) {
        return _mintingCurrency;
    }
    
    function setMintingPrice(uint256 newMintingPrice) onlyOwner public {
        _mintingPrice = newMintingPrice;
    }
    
    function setMintingCurrency(TRC20Spendable newMintingCurrency) public onlyOwner {
...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
     ...
     */
    function mintWithTokenURI(address to, uint256 tokenId, string memory tokenURI) public onlyMinter {
        _mint(to, tokenId);
...
contract EcoryptoNFT is TRC721, TRC721Enumerable, TRC721MetadataMintable, TRC721Mintable {
    constructor() public TRC721Metadata("EcoryptoNFT", "ECON") {}
}
